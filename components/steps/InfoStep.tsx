...
export function InfoStep() {
  ...
  const mapsQuery = encodeURIComponent(config.address);
  const mapsEmbedSrc = `https://maps.google.com/maps?q=${mapsQuery}&output=embed`;
  const mapsOpenHref = `https://maps.google.com/?q=${mapsQuery}`;
      ...
      <div className="px-4 flex flex-col gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-inter font-semibold text-gray-900 text-base">Punto de retiro</h2>
          </div>
          <iframe
            src={mapsEmbedSrc}
            width="100%"
          ...
          <a
            ...
            className="mt-3 inline-flex items-center gap-1.5 font-inter font-semibold text-sm underline underline-offset-2 active:opacity-80 transition-opacity"
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-lg">🕐</span>
            <h2 className="font-inter font-semibold text-gray-900 text-base">Turnos disponibles</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-lg">🏦</span>
            <h2 className="font-inter font-semibold text-gray-900 text-base">Datos bancarios</h2>
          </div>
